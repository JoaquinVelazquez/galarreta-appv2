...
if (isset($mes_1_array)) {
    foreach ($mes_1_array as $data) {
        switch ($data["plataforma"]) {
            case 'meli':
                array_push($mes_1_meli, $data["monto"]);
                break;
            case 'mshops':
                array_push($mes_1_mshops, $data["monto"]);
                break;
        }
    }
}
...
if (isset($mes_2_array)) {
    foreach ($mes_2_array as $data) {
        switch ($data["plataforma"]) {
            case 'meli':
                array_push($mes_2_meli, $data["monto"]);
                break;
            case 'mshops':
                array_push($mes_2_mshops, $data["monto"]);
                break;
        }
    }
}
...
if (isset($mes_3_array)) {
    foreach ($mes_3_array as $data) {
        switch ($data["plataforma"]) {
            case 'meli':
                array_push($mes_3_meli, $data["monto"]);
                break;
            case 'mshops':
                array_push($mes_3_mshops, $data["monto"]);
                break;
        }
    }
}
...
if (isset($mes_4_array)) {
    foreach ($mes_4_array as $data) {
        switch ($data["plataforma"]) {
            case 'meli':
                array_push($mes_4_meli, $data["monto"]);
                break;
            case 'mshops':
                array_push($mes_4_mshops, $data["monto"]);
                break;
        }
    }
}
...
if (isset($mes_5_array)) {
    foreach ($mes_5_array as $data) {
        switch ($data["plataforma"]) {
            case 'meli':
                array_push($mes_5_meli, $data["monto"]);
                break;
            case 'mshops':
                array_push($mes_5_mshops, $data["monto"]);
                break;
        }
    }
}
...
if (isset($mes_6_array)) {
    foreach ($mes_6_array as $data) {
        switch ($data["plataforma"]) {
            case 'meli':
                array_push($mes_6_meli, $data["monto"]);
                break;
            case 'mshops':
                array_push($mes_6_mshops, $data["monto"]);
                break;
        }
    }
}
...
foreach ($mes_7_array as $data) {
    switch ($data["plataforma"]) {
        case 'meli':
            array_push($mes_7_meli, $data["monto"]);
            break;
        case 'mshops':
            array_push($mes_7_mshops, $data["monto"]);
            break;
    }
}
...
foreach ($mes_8_array as $data) {
    switch ($data["plataforma"]) {
        case 'meli':
            array_push($mes_8_meli, $data["monto"]);
            break;
        case 'mshops':
            array_push($mes_8_mshops, $data["monto"]);
            break;
    }
}
...
foreach ($mes_9_array as $data) {
    switch ($data["plataforma"]) {
        case 'meli':
            array_push($mes_9_meli, $data["monto"]);
            break;
        case 'mshops':
            array_push($mes_9_mshops, $data["monto"]);
            break;
    }
}
...
foreach ($mes_10_array as $data) {
    switch ($data["plataforma"]) {
        case 'meli':
            array_push($mes_10_meli, $data["monto"]);
            break;
        case 'mshops':
            array_push($mes_10_mshops, $data["monto"]);
            break;
    }
}
...
foreach ($mes_11_array as $data) {
    switch ($data["plataforma"]) {
        case 'meli':
            array_push($mes_11_meli, $data["monto"]);
            break;
        case 'mshops':
            array_push($mes_11_mshops, $data["monto"]);
            break;
    }
}
...
foreach ($mes_12_array as $data) {
    switch ($data["plataforma"]) {
        case 'meli':
            array_push($mes_12_meli, $data["monto"]);
            break;
        case 'mshops':
            array_push($mes_12_mshops, $data["monto"]);
            break;
    }
}
@endphp
...
<body>
    <div>
        <canvas id="evolucion_canal_facturacion"></canvas>
    </div>
    ...
    <script>
        ...
        const config2 = {
            ...
            options: {
                plugins: {
                    title: {
                        display: true,
                        text: 'Evolución de Canal - Facturación'
                    },
                },
                responsive: true,
                scales: {
        ...
        var myChart2 = new Chart(
            document.getElementById('evolucion_canal_facturacion').getContext('2d'),
            config2
        );
    </script>
</body>
