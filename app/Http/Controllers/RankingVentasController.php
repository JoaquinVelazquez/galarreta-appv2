...
class RankingVentasController extends Controller
{
    public function show($id)
    {
        ...
        $fecha_inicial = date("y-m-d", strtotime($fecha_actual . "- 31 days"));
        ...
        return view ('apanel.ranking_productos', compact('seller', 'ordenes_seller'));
    }
}
